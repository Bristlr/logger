...
describe("index.js", function() {
	...
	it("Logger can count a value", function(done) {
		...
		assert.equal(loggedString, "MONITORING|123456|2|count|cats|");
		done();
	...
	it("Logger counts 1 by default", function(done) {
		...
		assert.equal(loggedString, "MONITORING|123456|1|count|sheep|");
		done();
	...
	it("Logger can measure a value", function(done) {
		...
		assert.equal(loggedString, "MONITORING|123456|0.66|measure|dogs.speed|");
		done();
	...
	it("Logger can time a value and save it in as a ms measure", function(done) {
		...
		assert.equal(loggedString, "MONITORING|123456|128ms|measure|cows|");
		done();
